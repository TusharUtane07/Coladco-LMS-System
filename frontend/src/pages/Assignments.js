...
import { assignmentsApi, jobPostingApi } from "../urls/urls";
...
const Assignments = () => {
  ...
  useEffect(() => {
    assignmentsFetch(assignmentsApi());
  }, []);

  useEffect(() => {
    if (assignmentsFetch?.data) {
            ...
            <div className="middle-sidebar-left">
              <div className="row">
                <div className="col-lg-12 mt-3 d-flex flex-row justify-content-center flex-wrap">
                  {assignmentsResponse?.data?.map((value, index) => (
                    <div
